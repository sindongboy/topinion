...
/**
 * LDA Topic clustering driver for NLP processed Document Set
 *
 * @author Donghun Shin, donghun.shin@sk.com
 * @date 11/6/14.
 */
public class NLPLDADriver {
    private static final Logger LOGGER = Logger.getLogger(NLPLDADriver.class.getName());
    ...
    public static void main(String[] args) throws IOException {
	    ...
	    cli.addOption("o", "output", true, "path to where the model is saved", true);
        ...
        Loader loader = new NLPDocumentLoader();
        loader.load(cli.getOption("i"));
        List<Document> documents = loader.getDocuments();
        etime = System.currentTimeMillis();
        LOGGER.info("Document Loading done in " + timeTakenString(btime, etime));
        ...
        etime = System.currentTimeMillis();
        LOGGER.info("Clustering done in " + timeTakenString(btime, etime));

	    // save mode
	    cluster.saveModel(cli.getOption("o"));
        ...
        etime = System.currentTimeMillis();
        LOGGER.info("Topic Allocation done in " + timeTakenString(btime, etime));
        ...
        etime = System.currentTimeMillis();
        LOGGER.info("Topic Keyword writing start done in " + timeTakenString(btime, etime));
        keywordWriter.close();
        topicWriter.close();
    }

    /**
     * Time Taken as String
     * @param btime begin time
     * @param etime end time
     * @return time taken
     */
    static String timeTakenString(long btime, long etime) {
